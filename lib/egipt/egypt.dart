...
import 'package:flutter_web_1/egipt/page2.dart';
import 'package:flutter_web_1/egipt/page3.dart';
  ...
  void initState() {
    ...
    _scrollController = ScrollController()
      ..addListener(() => setState(() {
            if (_scrollController.offset >= screenHeight) {
